...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">DR</a></h1>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Diana Rosero</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
